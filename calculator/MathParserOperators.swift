...
struct Sin: MathParserOperator {
    ...
    func evaluate(numbers: [Double]) -> Double {
        ...
        case .Radians:
            result = sin(number)
        case .Degrees:
            result = sin(degreeToRadian(degree: number))
        }
...
struct Cos: MathParserOperator {
    ...
    func evaluate(numbers: [Double]) -> Double {
        ...
        case .Radians:
            result =  cos(number)
        case .Degrees:
            result =  cos(degreeToRadian(degree: number))
        }
...
struct Tan: MathParserOperator {
    ...
    func evaluate(numbers: [Double]) -> Double {
        ...
        case .Radians:
            result =  tan(number)
        case .Degrees:
            result =  tan(degreeToRadian(degree: number))
        }
...
struct Sinh: MathParserOperator {
    ...
    func evaluate(numbers: [Double]) -> Double {
        ...
        case .Radians:
            result =  sinh(number)
        case .Degrees:
            result =  sinh(degreeToRadian(degree: number))
        }
...
struct Cosh: MathParserOperator {
    ...
    func evaluate(numbers: [Double]) -> Double {
        ...
        case .Radians:
            result = cosh(number)
        case .Degrees:
            result = cosh(degreeToRadian(degree: number))
        }
...
struct Tanh: MathParserOperator {
    ...
    func evaluate(numbers: [Double]) -> Double {
        ...
        case .Radians:
            result = tanh(number)
        case .Degrees:
            result = tanh(degreeToRadian(degree: number))
        }
...
struct Asin: MathParserOperator {
    ...
    func evaluate(numbers: [Double]) -> Double {
        ...
        if mathParserAngleUnits == .Degrees {
            result = radianToDegree(radian: result)
        }
...
let mathParserOperators: [String: MathParserOperator] = ["+": Addition(), "-": Subtraction(), "x": Multiplication(), "÷": Division(),
